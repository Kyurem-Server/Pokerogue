...
export abstract class PokemonSpeciesForm {
   ...
   */
  public getLevelMoves(formKey?: string, getReal = false): LevelMoves {
    if (!getReal) {
...
export class PokemonForm extends PokemonSpeciesForm {
  ...
  */
  public override getLevelMoves(getReal = false): LevelMoves {
    return super.getLevelMoves(getReal ?? false);
  }
}
